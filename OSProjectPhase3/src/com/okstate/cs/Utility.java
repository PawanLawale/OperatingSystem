...
public class Utility {
	...
	public static String binaryDivision(String jobId,String binary1,String binary2){
		String result = null;
		int b1 = (short)Integer.parseInt(binary1, 2);
		int b2 = (short)Integer.parseInt(binary2, 2);
		if(b2 == 0){
			ErrorHandler.jobErrors.put(jobId, ErrorHandler.recordError(112));
			ProcessManager.error = true;
		}else{
			int b3 = (short)(b1 / b2);
			result = decimalToBinary(b3, 16);
		}
		return result;
	}
